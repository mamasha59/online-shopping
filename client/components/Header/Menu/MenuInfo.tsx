...
const MenuInfo:FC = () => {
  ...
  return (
    <div className="p-2 flex items-center justify-around relative lg:flex-col">
      <Logo/>     {/* компонент логотипа бренда */}
      <CallOrderButton title="Заказать звонок"/> {/* компонент кнопки заказать звонок */}
      ...
      <div className="flex mt-3 items-center md:w-full sm:flex-col md:justify-evenly gap-10">
        ...
        <CartButton title="Корзина"/>   {/* компонент кнопки корзины */}
      </div>
    </div>
  );
};
