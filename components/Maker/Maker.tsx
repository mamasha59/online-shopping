...
const Maker:FC = () => {
  return (
    <section className="body-center text-green py-3">
      <div className="border-[#2fb4205c] border-solid border-[1px] rounded-md p-3 relative md:border-none">
        ...
        <button className="text-lg -bottom-[10px] absolute left-5 bg-[#fff] px-3 hover:text-xl hover:text-[#16a085] hover:opacity-90 transition-all">
          Все производители
        </button>
      </div>
    </section>
